...
export default function FAQ() {
  ...
  return (
    <section className="w-full bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-bl from-brand-navy/5 to-transparent"></div>
      ...
      <div className="container-content section-spacing relative">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              {/* Bold left gradient accent when open */}
              <div className={`absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-brand-lightBlue to-brand-navy transition-opacity ${openIndex === index ? 'opacity-100' : 'opacity-0'}`}></div>
