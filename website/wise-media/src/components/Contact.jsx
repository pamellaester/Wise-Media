        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-14 md:mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              <article className="bg-white rounded-2xl p-6 text-center group hover:shadow-xl transition-all duration-300">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-brand-navy/5 mb-5 group-hover:bg-brand-navy/10 transition-colors duration-300">
                  <Icon name="Mail" size={22} className="text-brand-navy" />
                </div>
                <h3 className="text-base font-semibold text-brand-navy mb-2">{t('contact.methods.email.title')}</h3>
                <p className="text-xs text-brand-navy/50 mb-4 leading-relaxed">{t('contact.methods.email.description')}</p>
                <a
                  href="mailto:wisemediasolucoes@gmail.com"
                  className="text-brand-accent hover:text-brand-navy transition-colors text-sm font-semibold"
                >
              ...
              <article className="bg-white rounded-2xl p-6 text-center group hover:shadow-xl transition-all duration-300">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-brand-navy/5 mb-5 group-hover:bg-brand-navy/10 transition-colors duration-300">
                  <Icon name="MessageCircle" size={22} className="text-brand-navy" />
                </div>
                <h3 className="text-base font-semibold text-brand-navy mb-2">{t('contact.methods.whatsapp.title')}</h3>
                <p className="text-xs text-brand-navy/50 mb-4 leading-relaxed">{t('contact.methods.whatsapp.description')}</p>
                <a
              ...
              <article className="bg-white rounded-2xl p-6 text-center group hover:shadow-xl transition-all duration-300">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-brand-navy/5 mb-5 group-hover:bg-brand-navy/10 transition-colors duration-300">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-brand-navy">
                    <rect width="20" height="20" x="2" y="2" rx="5" ry="5" />
                    <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" />
                    <line x1="17.5" x2="17.51" y1="6.5" y2="6.5" />
                  </svg>
                </div>
                <h3 className="text-base font-semibold text-brand-navy mb-2">{t('contact.methods.instagram.title')}</h3>
                <p className="text-xs text-brand-navy/50 mb-4 leading-relaxed">{t('contact.methods.instagram.description')}</p>
                <a
          ...
          <div className="mb-14 md:mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              <article className="bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/12 hover:border-white/20 transition-all duration-300">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-brand-lightBlue/90 to-white mb-5 shadow-lg">
                  <Icon name="MessageSquare" size={22} className="text-brand-navy" />
                </div>
                <h3 className="text-base font-semibold text-white mb-3">{t('contact.process.initial.title')}</h3>
              ...
              <article className="bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/12 hover:border-white/20 transition-all duration-300">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-brand-lightBlue/90 to-white mb-5 shadow-lg">
                  <Icon name="Search" size={22} className="text-brand-navy" />
                </div>
                <h3 className="text-base font-semibold text-white mb-3">{t('contact.process.analysis.title')}</h3>
                <p className="text-white/60 text-sm leading-relaxed">
              ...
              <article className="bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/12 hover:border-white/20 transition-all duration-300">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-brand-lightBlue/90 to-white mb-5 shadow-lg">
                  <Icon name="FileText" size={22} className="text-brand-navy" />
                </div>
                <h3 className="text-base font-semibold text-white mb-3">{t('contact.process.plan.title')}</h3>
                <p className="text-white/60 text-sm leading-relaxed">
